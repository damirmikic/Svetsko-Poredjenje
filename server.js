...
const SUPERBET_DETAIL_TIMEOUT_MS = Number(process.env.SUPERBET_DETAIL_TIMEOUT_MS || Math.max(FEED_TIMEOUT_MS, 12000));
const SUPERBET_DETAIL_CHUNK_SIZE = Number(process.env.SUPERBET_DETAIL_CHUNK_SIZE || 1);
