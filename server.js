...
const COMPETITIONS = [
  ...
  },
  {
    ...
    terms: ["bundesliga", "germany 1", "nemacka 1", "nemačka 1"],
    pinnacleLeagueCode: "germany-bundesliga",
    nsoftTournamentId: 87,
    superbetTournaments: ["245"],
    oddsmathLeagueId: 1219,
    dualsoftCountry: ["Germany", "Nemacka", "Nemačka"],
    dualsoftLeagueName: ["Bundesliga", "Germany 1", "Nemacka 1", "Nemačka 1"],
    mozzartCountryTerm: "nem",
    mozzartLeagueTerm: "1",
    btfTerms: ["bundesliga"],
  },
  {
    ...
    terms: ["ligue 1", "france 1", "francuska 1"],
    pinnacleLeagueCode: "france-ligue-1",
    nsoftTournamentId: 84,
    superbetTournaments: ["100"],
    oddsmathLeagueId: 1083,
    dualsoftCountry: ["France", "Francuska"],
    dualsoftLeagueName: ["Ligue 1", "France 1", "Francuska 1"],
  ...
  },
  {
    id: "serie-a",
    label: "Italy - Serie A",
    terms: ["serie a", "italy 1", "italija 1"],
    pinnacleLeagueCode: "italy-serie-a",
    nsoftTournamentId: 51,
    superbetTournaments: ["104"],
    oddsmathLeagueId: 1315,
    dualsoftCountry: ["Italy", "Italija"],
    dualsoftLeagueName: ["Serie A", "Italy 1", "Italija 1"],
  ...
  },
  {
    id: "laliga",
    label: "Spain - LaLiga",
    terms: ["la liga", "laliga", "spain 1", "spanija 1", "španija 1", "primera"],
    pinnacleLeagueCode: "spain-la-liga",
    nsoftTournamentId: 15,
    superbetTournaments: ["98"],
    oddsmathLeagueId: 1122,
    dualsoftCountry: ["Spain", "Spanija", "Španija"],
    dualsoftLeagueName: ["LaLiga", "Spain 1", "Spanija 1", "Španija 1", "Primera"],
...
export async function getOddsPayload(competitionId) {
  ...
  // Awaited (not fire-and-forget): a serverless invocation that returns while
  // this is still in flight gets frozen mid-fetch by the Lambda runtime, which
  // has caused "Promise that was never settled" crashes on Netlify.
  try {
